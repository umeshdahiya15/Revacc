...
def build_job(job_id: str, create: JobCreate) -> Job:
    ...
    return Job(
        ...
        config={
            ...
            "enableMevEnhancements": create.enableMevEnhancements,
            "adjuvantSequence": create.adjuvantSequence,
            "adjuvantSource": create.adjuvantSource,
            "signalPeptideSequence": create.signalPeptideSequence,
            "signalPeptideSource": create.signalPeptideSource,
